...
<body class="bgall">
	<div class="size bgall col-lg-10 col-md-10 col-12 m-auto p-1">
		...
		<div
			...
			<form id="e-form" method="post" action="index.php"
				class=" mt-4 col-lg-8 col-md-10 col-sm-11 col-xs-11 m-auto">
		...
		<div class="p-2 bg1 mb-1 forms lender-form col-lg-10 col-md-10 col-sm-10 col-xs-10 mt-1 m-auto overflow-hidden">
			...
			<form method="post" id="l-form" action="index.php"
				class="mt-4 col-lg-8 col-md-10 col-sm-11 col-xs-11 m-auto">
		...
		<div
			...
			<table id="notreceive_table"
				class="table display table-striped table-bordered table-dark text-center  mt-4">
				<thead>
					<tr>
						<th class="p-0 m-0">Name</th>
						<th class="p-0 m-0">Amount</th>
		...
		<div class="bg1 p-2 mb-1 forms borrow-form col-lg-10 col-md-10 col-sm-10 col-xs-10 mt-1 m-auto overflow-hidden">
			...
			<form id="b-form" method="post" action="index.php"
				class="mt-4 col-lg-8 col-md-10 col-sm-11 col-xs-11 m-auto">
		...
		<div
			...
			<form method="post" id="i-form" action="index.php"
				class="mt-4 col-lg-8 col-md-10 col-sm-11 col-xs-11 m-auto">
		...
		<div class="bg1 p-2 mb-1 forms income-form col-lg-10 col-md-10 col-sm-10 col-xs-10 mt-1 m-auto overflow-hidden">
			...
			<form method="post" id="in-form" action="index.php"
				class="mt-4 col-lg-8 col-md-10 col-sm-11 col-xs-11 m-auto">
