...
<body style="background-image: url('assest/img2.jpg');">
	...
	<div class="d-flex justify-content-center align-items-center" style="height:100vh;">
			...
			<form method="post" id="contactform" action="register.php" class="forms border col-lg-4 col-md-5 col-sm-8 col-10 bg-info rounded-3 bg-gradient pt-5 pb-5 px-3 py-3" >
	...
	$(document).ready(function(){
		  ...
		  $('#submit').click(function(){
			   ...
			   if(name== ''){
				...
				//ajax call php page
				$.post("index.php", $("#contactform").serialize(),  function(response) {
